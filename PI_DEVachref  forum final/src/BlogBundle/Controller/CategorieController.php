...
//    public function categorieSearchAction(Request $request, Categorie $categorie)
//    {
//
//        $em = $this->getDoctrine()->getManager();
////        $article = $em->getRepository('BlogBundle:Article')->findByCategorie($categorie);
//        $article = $em->getRepository('BlogBundle:Article')->findBycategorie($categorie);
////        if ($this->get('security.authorization_checker')->isGranted('ROLE_ADMIN')) {
////            return $this->render('categorie/index.html.twig', array('categories' => $article,));
////        } else {
