...
class Article extends \BlogBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'titre', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'auteur', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'description', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'dateCreation', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'dateEdition', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'image', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'categorie'];
        }
