...
'attr' => array('placeholder' => 'Titre', 'class' => 'form-control border-color-1')))->add('salaire', IntegerType::class, array(
'attr' => array('placeholder' => 'salaire en DT', 'class' => 'form-control border-color-5')))->add('description', TextareaType::class, array(
'attr' => array('placeholder' => 'Description', 'class' => 'form-control border-color-4')))->add('speciality', TextareaType::class, array(
    'attr' => array('placeholder' => 'speciality', 'class' => 'form-control border-color-4')))->add('save', SubmitType::class, array(
 ...
 public function ListeannoncesAction(Request $request)
    {
        ...
        $data = array('listeannonce' => $listeannonce,);
