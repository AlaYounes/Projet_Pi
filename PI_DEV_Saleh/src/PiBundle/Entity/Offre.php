 ...
 * @ORM\Entity(repositoryClass="PiBundle\Repository\OffreRepository")
 */
class Offre
{
    /**
     ...
     * @var int
     *
     * @ORM\Column(name="travailfait", type="integer")
     */
    private $travailfait;
     ...
     * @var float
     *
     * @ORM\Column(name="heurest", type="float")
     */
    private $heurest;
     ...
     * @return Offre
     */
    public function setHeurest($heurest)
    {
