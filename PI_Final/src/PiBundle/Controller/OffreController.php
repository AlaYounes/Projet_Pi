...
use PiBundle\Entity\Freelancer;
use Swift_Message;
...
class OffreController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $offres = $em->getRepository('PiBundle:Freelancer')->findBy(array(), array('travailfait' => 'DESC'));
    ...
    {
        $offre = new Freelancer();
        $form = $this->createForm('PiBundle\Form\FreelancerType', $offre);
     ...
     * @Method("GET")
     */
    public function showAction(Freelancer $offre)
    {
     ...
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Freelancer $offre)
    {
        $deleteForm = $this->createDeleteForm($offre);
        $editForm = $this->createForm('PiBundle\Form\FreelancerType', $offre);
     ...
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Freelancer $offre)
    {
     ...
     *
     * @param Freelancer $offre The Freelancer entity
     *
     * @return \Symfony\Component\Form\Form The form
     */
    private function createDeleteForm(Freelancer $offre)
    {
    ...
    public function rechercheOffreAction(Request $request)
    {
        ...
        if($request->getMethod('POST'))
        {
            ...
            $offres=$this->getDoctrine()->getRepository(Freelancer::class)->findByName($nom,$travailfait);
            $offres  = $this->get('knp_paginator')->paginate(
                $offres,
                $request->query->get('page', 1)/*le numéro de la page à afficher*/,
